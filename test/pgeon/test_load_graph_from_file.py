...
class TestLoadGraphFromFile(unittest.TestCase):
    ...
    def test_load_pg_from_nodes_and_edges(self):
        ...
        self.assertEqual(len(pg.edges), 18)
        ...
        self.assertAlmostEqual(pg.nodes[p[2]]['probability'], 0.51863, delta=0.001)
        self.assertEqual(pg.nodes[p[2]]['frequency'], 2464)

        self.assertIn((p[1], p[2], 1), pg.edges)
        self.assertIn((p[2], p[1], 0), pg.edges)
        self.assertIn((p[3], p[3], 1), pg.edges)
        self.assertIn((p[2], p[1], 0), pg.edges)
        self.assertIn((p[2], p[3], 0), pg.edges)
        self.assertIn((p[1], p[0], 1), pg.edges)

        self.assertAlmostEqual(pg.edges[(p[1], p[3], 1)]['probability'], 0.06126, delta=0.001)
        self.assertEqual(pg.edges[(p[1], p[3], 1)]['frequency'], 74)
        self.assertEqual(pg.edges[(p[1], p[3], 1)]['action'], 1)
        self.assertAlmostEqual(pg.edges[(p[1], p[1], 1)]['probability'], 0.26738, delta=0.001)
        self.assertEqual(pg.edges[(p[1], p[1], 1)]['frequency'], 323)
        self.assertEqual(pg.edges[(p[1], p[1], 1)]['action'], 1)
        self.assertAlmostEqual(pg.edges[(p[3], p[0], 0)]['probability'], 0.21829, delta=0.001)
        self.assertEqual(pg.edges[(p[3], p[0], 0)]['frequency'], 74)
        self.assertEqual(pg.edges[(p[3], p[0], 0)]['action'], 0)
    ...
    def test_load_pg_from_nodes_and_trajectories(self):
        ...
        self.assertEqual(pg.nodes[p[0]]['frequency'], 33)
        self.assertEqual(pg.nodes[p[1]]['frequency'], 52)
        ...
        self.assertIn((p[0], p[2], 1), pg.edges)
        self.assertIn((p[0], p[1], 0), pg.edges)
        self.assertIn((p[0], p[3], 1), pg.edges)
        self.assertIn((p[1], p[1], 0), pg.edges)
        self.assertIn((p[1], p[1], 1), pg.edges)
        self.assertIn((p[1], p[0], 1), pg.edges)
        self.assertIn((p[1], p[3], 1), pg.edges)
        self.assertIn((p[1], p[2], 1), pg.edges)
        self.assertIn((p[2], p[2], 1), pg.edges)
        self.assertIn((p[2], p[2], 0), pg.edges)
        self.assertIn((p[2], p[3], 0), pg.edges)
        self.assertIn((p[2], p[0], 0), pg.edges)
        self.assertIn((p[2], p[1], 0), pg.edges)
        self.assertIn((p[3], p[1], 0), pg.edges)
        self.assertIn((p[3], p[2], 1), pg.edges)
        self.assertIn((p[3], p[0], 0), pg.edges)
        self.assertIn((p[3], p[3], 1), pg.edges)
        self.assertIn((p[3], p[3], 0), pg.edges)
        self.assertEqual(pg.edges[(p[0], p[2], 1)]['frequency'], 10)
        self.assertEqual(pg.edges[(p[0], p[1], 0)]['frequency'], 19)
        self.assertEqual(pg.edges[(p[0], p[3], 1)]['frequency'], 3)
        self.assertEqual(pg.edges[(p[1], p[1], 0)]['frequency'], 15)
        self.assertEqual(pg.edges[(p[1], p[1], 1)]['frequency'], 12)
        self.assertEqual(pg.edges[(p[1], p[0], 1)]['frequency'], 17)
        self.assertEqual(pg.edges[(p[1], p[3], 1)]['frequency'], 4)
        self.assertEqual(pg.edges[(p[1], p[2], 1)]['frequency'], 2)
        self.assertEqual(pg.edges[(p[2], p[2], 1)]['frequency'], 13)
        self.assertEqual(pg.edges[(p[2], p[2], 0)]['frequency'], 15)
        self.assertEqual(pg.edges[(p[2], p[3], 0)]['frequency'], 7)
        self.assertEqual(pg.edges[(p[2], p[0], 0)]['frequency'], 8)
        self.assertEqual(pg.edges[(p[2], p[1], 0)]['frequency'], 1)
        self.assertEqual(pg.edges[(p[3], p[1], 0)]['frequency'], 5)
        self.assertEqual(pg.edges[(p[3], p[2], 1)]['frequency'], 5)
        self.assertEqual(pg.edges[(p[3], p[0], 0)]['frequency'], 4)
        self.assertEqual(pg.edges[(p[3], p[3], 1)]['frequency'], 4)
        self.assertEqual(pg.edges[(p[3], p[3], 0)]['frequency'], 5)
