...
class TestLoadGraphFromFile(unittest.TestCase):
    ...
    def test_load_pg_from_nodes_and_edges(self):
        pg = PolicyGraph.from_nodes_and_edges(
            self.pg_csv_nodes, self.pg_csv_edges, self.env, self.discretizer
        )
    ...
    def test_load_pg_from_nodes_and_trajectories(self):
        pg = PolicyGraph.from_nodes_and_trajectories(
            self.pg_csv_nodes, self.pg_csv_trajectories, self.env, self.discretizer
        )
